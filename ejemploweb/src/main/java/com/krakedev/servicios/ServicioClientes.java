...
public class ServicioClientes {
	...
	public String saludar() {
		return "Hola mundo Rest Web Services, me llamo  Becker";
	}
	...
	public Cliente buscar() {
		Cliente cli = new Cliente("0941088304","Becker",5);
		return cli;
	}
	...
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public Response actualizar(Cliente cli) {
		System.out.println("ACTUALIZANDO CLIENTE >>>>>>>> "+cli);
		ClientesBDD cliente = new ClientesBDD();
		try {
	...
	@Path("buscarPorNumeroDeHijos/{hijos}")
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	public Response buscarPorNumeroHijos(@PathParam("hijos") int numeroHijos){
		ClientesBDD cli = new ClientesBDD();
		ArrayList<Cliente> clientes = null;
		try {
